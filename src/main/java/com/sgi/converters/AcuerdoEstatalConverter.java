...
@FacesConverter("acuerdoEstatalConverter")
public class AcuerdoEstatalConverter implements Converter{
    @Override
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                List<Catacuerdo> acuerdos = (List<Catacuerdo>)sc.getAttribute("catalogo_acuerdos_estatales");
